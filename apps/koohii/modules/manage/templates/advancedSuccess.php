...
<ul>
  <li>
    ...
    <span class="fld medium"><?php echo input_tag('f_kanji', '', array('class' => 'textfield')) ?></span>
  </li>
  <li>
    <span class="lbl"><?php echo label_for('f_leitnerbox', 'Leitner Box') ?></span>
    <span class="fld medium"><?php echo input_tag('f_leitnerbox', '2', array('class' => 'textfield')) ?> (1 = fail/new, 2 = one review, ...)</span>
  </li>
  <li>
    <span class="lbl"><?php echo label_for('f_expiredays', 'Due date') ?></span>
    <span class="fld medium"><?php echo input_tag('f_expiredays', '0', array('class' => 'textfield')) ?> (in DAYS from now, 0 = due)</span>
  </li>
  <li>
    <span class="lbl"><?php echo label_for('f_failurecount', 'Fail count') ?></span>
    <span class="fld medium"><?php echo input_tag('f_failurecount', '0', array('class' => 'textfield')) ?></span>
  </li>
  <li>
    <span class="lbl"><?php echo label_for('f_successcount', 'Sucess count') ?></span>
    <span class="fld medium"><?php echo input_tag('f_successcount', '1', array('class' => 'textfield')) ?></span>
  </li>
