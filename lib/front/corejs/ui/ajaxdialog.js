...
/* Sam Skin CSS */
/* !require "/container/assets/skins/sam/container.css" */
...
(function() {
  ...
  var 
    ...
    DIALOG_LOADING_HTML = '<div class="body ajax-loading" {style}"></div>',
  ...
  AjaxDialog.prototype = {
    ...
    onPanelInit: function(tron)
    {
      ...
      // clear loading icon, obsolete: ajaxpanel does this
