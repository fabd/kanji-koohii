 ...
 *                                    Must contain child element with class "msg" which will be set$
 *                                    to the error message. Must contain a link that will enable
...
(function(){
  ...
  Core.Ui.AjaxQueue.prototype =
  {
    ...
    next: function()
    {
      ...
      Core.log('AjaxQueue.next(%o)', blob);
    ...
    send: function(blob)
    {
      Core.log('AjaxQueue.send(%o)', blob);
    ...
    {
      Core.log('AjaxQueue::onAjaxSuccess(%o)', o);
    ...
    {
      Core.log('AjaxQueue::onAjaxFailure(%o)', o);
    ...
    setErrorDialog: function(sErrorMessage)
    {
      if (sErrorMessage)
      {
        var el = Dom.down(this.elAjaxError, 'msg');
