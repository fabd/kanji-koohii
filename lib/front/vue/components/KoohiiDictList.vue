<template>
  ...
  <div v-else class="dict-list_info">
...
.dict-list dt    { padding:1em 20px;  border-top:1px solid #eee; font-weight:normal; }
.dict-list dt .c { font-size:22px; padding:0; display:inline-block; color:#000; /*border-radius:3px;*/ }
