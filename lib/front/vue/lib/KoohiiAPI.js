...
const KoohiiAPI = {
  ...
  setVocabForCard({ ucs: ucs, dictid: dictid }, handlers)
  {
    ...
    KoohiiRequest.request('/study/vocabpick', { method: 'post', data: data}, handlers)
  },

  deleteVocabForCard({ ucs: ucs }, handlers)
  {
    let data = { ucs: ucs }
    KoohiiRequest.request('/study/vocabdelete', { method: 'post', data: data}, handlers)
  }
}
