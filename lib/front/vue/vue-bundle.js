...
// helper to instantiate Vue components (Vue component, string selector, object propsData)
window.VueInstance = (component, mountPoint, propsData) => {

  const el     = KOOHII.Dom(mountPoint)[0]
