...
- if the branch name is `develop`, determine a meaningful branch name (see Naming Branch below), then go ahead and **rename** the current branch (do not use checkout -b)
