...
class rtkLabs
{
   ...
   */
  public const TABLE_JDICT = 'jdict';
   ...
   */
  public const TABLE_DICTSPLIT = 'dictsplit';
  public const TYPE_ON         = 1;
  public const TYPE_KUN        = 2;
   ...
   */
  public const TABLE_DICTLEVELS = 'dictlevels';
   ...
   *  pron           Kana string
   */
  public const TABLE_DICTPRONS = 'dictprons';
   ...
   */
  public const TABLE_KANJIPRON_TO_DICT = 'v_kanjipron_to_dict';
   ...
   */
  public const TABLE_KANJIPRONSTATS = 'v_kanjipronstats';
  ...
  public const EDICT_PRI_FREEMODE = 0xCA;

  // jdict.pri: ichi1, news1, news2 entries for example words on flashcards
  public const EDICT_PRI_SHUFFLE = 0xCA;

  // jdict.pos (INT UNSIGNED 32bits)
  public static $dictpos = [
    // <pos>
  ...
  public const VOCABSHUFFLE_MINBOX = 2;

  // max. number of cards in a Vocab Shuffle session
  public const VOCABSHUFFLE_LENGTH = 50;
