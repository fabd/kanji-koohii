...
(e.g.: <?= link_to(sfConfig::get('app_website_url').'/study/kanji/2011', '@study_edit?id=2011'); ?>)
          </li>
          <li>
...
(e.g.: <?= link_to(sfConfig::get('app_website_url').'/profile/fuaburisu', 'profile/index?username=fuaburisu'); ?> )
          </li>
        </ul>
        <p>
