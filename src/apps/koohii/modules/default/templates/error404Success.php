<div class="pure-u-1 pure-u-md-3-5 markdown">
  ...
  <p> If you reached this page from another part of this site, please <?= link_to('let us know', '@contact'); ?> so we can correct our mistake.</p>
  
  <h3>Did you follow a link from another site?</h3>
  
  <p> Links from other sites can sometimes be outdated or misspelled. <?= link_to('Let us know', '@contact'); ?> where you came from and we can try to contact the other site in order to fix the problem.</p>

  <ul>
      <li><a href="javascript:history.go(-1)">Go back to previous page</a></li>
      <li><?= link_to('Visit the home page', '@homepage'); ?></li>
  </ul>
