...
<?= form_tag('manage/addCustomConfirm', ['class' => 'main-form']); ?>

<div class="markdown">
  <p> To add a custom selection of flashcards, enter one or more of the following:</p>
  <ul>
    <li><?= _CJ('Remembering the Kanji'); ?> frame numbers, eg: "1, 3, 5" or "1 3 5"<br/>
        <strong>Old Editions</strong>: for the <?= link_to_rk1_supplement(); ?> use range "3008-3030"</li>
    <li>A range of frame numbers, eg: "10-20" or "1-5, 10-15"</li>
    <li><?= _CJ_U('kanji'); ?> characters, eg: "一, 二, 三" or "一二三"</li>
  ...
  <?= _bs_submit_tag('Add Cards'); ?><em class="note">Note: there will be a confirmation step.</em>
