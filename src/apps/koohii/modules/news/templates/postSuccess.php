...
?>
    ...
    <div class="form-group">
      <div class="flex flex-nowrap -mx-1">
        <div class="w-[136px] mx-1">
          ...
          <?= input_tag('post_id', 0, ['class' => 'form-control']); ?>
        </div>
        <div class="w-9/12 mx-1">
          <label class="form-label" for="name">Title</label>
          <?= input_tag('post_title', '', ['class' => 'form-control']); ?>
        </div>
        <div class="w-2/12 mx-1">
          <label class="form-label" for="name">Published</label>
          <?= input_tag('post_date', '', ['class' => 'form-control']); ?>
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <?= textarea_tag('post_body', '', ['style' => 'min-height:600px', 'class' => 'form-control']); ?>
    </div>
    ...
    <div class="form-group">
      <?= submit_tag('Post', ['class' => 'ko-Btn ko-Btn--success ko-Btn--large']); ?>
