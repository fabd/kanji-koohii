...
<head>
  ...
  <style type="text/css">
body {
	font:14px/1.6em Verdana, Geneva, Arial, Helvetica, sans-serif; color:#000;
	margin:0; padding:0; background:#FDF9CA;
}	
...
<body>
  ...
  <a href="http://kanji.koohii.com" style="position:absolute;left:33px;top:22px;width:131px;"><img src="/images/maint/maintenance-logo.gif" style="border:none;"/></a>
	...
	<div class="main">
		...
		<p> Looks like the website encountered an unfortunate scenario also known as the HTTP 500 Error page!<br/>
		    <br/>
				If the problem persists <a href="http://kanji.koohii.com/contact">please let us know</a> so we can fix it!
    </p>

    <ul>
			<li>Go to the <a href="http://kanji.koohii.com">Kanji Koohii</a> homepage.</li>
		</ul>
