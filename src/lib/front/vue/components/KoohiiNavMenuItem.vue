...
.k-nav-menu {
  ...
  font-family:"Open Sans", Arial, sans-serif; font-size:24px;
}
.k-nav-menu-item { display:block; list-style:none; padding:0 0 0.5em; }
.k-nav-menu-item__label {
  position:relative; height:2em; line-height:2em; font-size:100%; 
  cursor:pointer; white-space:nowrap; overflow-x:hidden;
  transition:color .3s ease-out;
}

 /* colors */
.k-nav-menu-item,
.k-nav-menu-item a { color:#adb2b6; }

 /* alignment */
.k-nav-menu-item__label { padding-left:3.4em; }

 /* nav icons (left side) */
.k-nav-menu-item__label .fa {
  position:absolute; left:1em; top:50%; margin-top:-0.5em; width:1.41em; text-align:center;
}
...
.k-nav-menu-item.is-opened .k-nav-menu-item__label { color:#fff; }

.k-nav-menu-item a { display:block; color:#adb2b6; outline:none; text-decoration:none; }
