...
/**
 * Returns a _single_ HTMLElement reference, or null.
 * 
 * This is primarily intended as a helper for other methods, to accept a node
 * either as a DOM node reference, or a selector string.
 * 
 * @param {String | HTMLElement} sel
 * @return {HTMLElement | null}   Always return a DOM reference, or null
 */
export function getNode(sel) {
  return ( (isString(sel) ? document.querySelectorAll(sel)[0] : sel) || null )
}
 ...
 * @param {HTMLElement | String} refNode    Accepts HTML element or selector
 * 
