...
class PatreonPeer extends coreDatabaseTable
{
  ...
  public const PLEDGE_AMOUNT_ACTIVE = 100;

  // min. pledge amount (cents) for the reward that includes perks
  public const PLEDGE_AMOUNT_PERKS = 500;
   ...
   * @return bool
   */
  public static function updatePatron($data)
  {
   ...
   * @return array|false
   */
  public static function getPatronInfo($userId)
  {
