...
class ReviewsPeer extends coreDatabaseTable
{
   ...
   * @param bool   $merge True to merge flashcards from given box with higher boxes
   *
   ...
   *
   * @return bool True if update/skip/delete went succesfully
   */
   ...
   */
  public static function addSelection($userId, array $cardSel)
  {
   ...
   */
  public static function filterExistingCards($userId, array $cards)
  {
    $select = self::getInstance()->select('ucs_id');
    $select = self::filterByUserId($select, $userId);
   ...
   *
   * @return false|int[] Returns an array of succesfully deleted flashcard ids or false
   */
