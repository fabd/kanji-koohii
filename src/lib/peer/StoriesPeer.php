...
class StoriesPeer extends coreDatabaseTable
{
   ...
   * @param mixed $userId
   *
   * @return bool|int Number of rows, or FALSE
   */
   ...
   * @param bool   $bSubstituteLinks true to show frame number references as links otherwise plain text
   * @param bool   $linebreaks       replace CR/LF with BR tags
   *
   * @return string
   */
