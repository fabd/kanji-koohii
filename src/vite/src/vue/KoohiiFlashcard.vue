...
.uiFcLayout {
  ...
  background: #92c3e4;
  background: #92c3e4 linear-gradient(to bottom, #c4e6ff 0%, #92c3e4 100%) 100%/200%
...
.uiFcButtons .uiIBtnDefault {
  font-size: 16px;
  line-height: 41px;
  height: 42px;
} /* larger buttons for touch/mobile */
...
#uiFcButtons1.three-buttons #uiFcBtnAN {
  width: 18%;
} /* 3 buttons */
#uiFcButtons1.three-buttons #uiFcBtnAH {
  width: 18%;
}
#uiFcButtons1.three-buttons #uiFcBtnAY {
  width: 38%;
}
#uiFcButtons1.three-buttons #uiFcBtnAE {
  width: 18%;
}
...
@media screen and (max-width: 700px) {
  ...
  #uiFcButtons u {
    text-decoration: none;
  } /* hide the keyboard shortcut hints */
  #uiFcButtons h3 {
    display: none;
  } /* remove prompts to save space */
  ...
  #uiFcProgressBar .uiFcStBox {
    padding: 0;
    background: none; /* remove padding so it aligns neatly */
  }
  #uiFcProgressBar h3 {
    line-height: 21px;
    color: #ddd;
  ...
  #JsBtnHelp {
    display: none;
  } /* hide the keyboard shortcuts help */
